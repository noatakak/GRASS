    ...
    def process_code(self, skill):
        ...
        while retry > 0:
            try:
                ...
                code = "\n".join(code_pattern.findall(skill.content))
                ...
                ), f"Main function {main_function['name']} must take a first argument named 'bot'"
                ...
                error = e
                time.sleep(1)
        return f"Error parsing skill into code: {error}"
